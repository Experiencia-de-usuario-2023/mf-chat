...
export const Rooms = ({
  ...
  return (
    <div className="h-full w-full rounded-lg border border-slate-400 bg-gray-fondo3 md:h-1/2">
      <div className="flex justify-between rounded-t-md border border-slate-400 bg-gray-fondo1 p-2 text-white">
        <span>Unirse a salas existentes</span>
        {selectedRoom && (
